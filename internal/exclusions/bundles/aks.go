	...
	return func() exclusions.Exclusions {
		e := exclusions.Exclusions{
			Resources: []exclusions.ExcludedResource{
				...
				{
					Name:    "aks-managed-enforce-kubernetes-endpoints",
					Kind:    "ValidatingAdmissionPolicyBinding",
					Version: "admissionregistration.k8s.io/v1",
				},
				{
					Name:    "aks-managed-enforce-kubernetes-endpointslice",
					Kind:    "ValidatingAdmissionPolicyBinding",
					Version: "admissionregistration.k8s.io/v1",
				},
				{
					Name:    "azure-storage-account-[0-9a-z]+-secret",
					Kind:    "Secret",
					Version: "v1",
				},
				{
